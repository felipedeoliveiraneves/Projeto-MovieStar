    ...
    <header>
        <nav id="main-navbar" class="navbar navbar-expand-lg">
           ...
           <span id="moviestar-title">MovieStar</span>
            ...
            <button class="navbar-toggler" type="button" data_toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="toggle navigation">
                <i class="fas fa-bars"></i>
            </button>
            <form action="" method="GET" id="search-form" class="form-inline m-2 my-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="<?= $BASE_URL ?>auth.php" class="nav-link"> Entra/Cadastrar</a>
                    </li>
                </ul>
            </div>
        </nav>
